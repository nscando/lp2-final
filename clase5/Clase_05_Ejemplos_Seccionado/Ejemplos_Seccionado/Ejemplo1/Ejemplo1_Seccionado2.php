<?php
include_once 'arrayXXXX.php';  //aqui se incrusta toooodo el contenido de este script

include_once 'funciones.php';  //aqui se incrusta toooodo el contenido de este script
?>
